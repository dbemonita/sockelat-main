...
var options = {
  ...
  port: Number(argv.p) || Number(process.env.SOCKETCLUSTER_PORT) || Number(process.env.PORT) || 5000,
...
var start = function () {
  ...
  if (socketCluster.options.environment === 'dev') {
    ...
    scHotReboot.attach(socketCluster, {
      cwd: __dirname,
      ignored: ['public', 'drive', 'node_modules', 'README.md', 'Dockerfile', 'server.js', 'broker.js', /[\/\\]\./, '*.log']
    });
  }
};
